...
//   ENGINEER_EMAIL        — where client activity notifications go (e.g. studio@cndrecording.com)
//   NOTIFY_FROM_EMAIL     — verified Resend sender, e.g. "CND Sessions <notifications@cndrecording.com>"
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const { data: session, error } = await db
      .from('sessions')
      .select('title, client_name, client_email, private_link_token')
      .eq('id', sessionId)
      .single();
